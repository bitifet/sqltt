...
//  ＝＝＝＝＝＝
//
//    * CTE's need to be rendered on inclusion.
//    * That rendering should be done through LOCAL *data*.
//    * Bindings should continue working...
//    * Whole query should be rendered using current engine.
//
//  －－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－
//  －－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－
    ...
    // console.log ("---------------");
    // ///console.log (src.sql(me.eng.flavour));
    // console.log (me.target.source.data);
    // console.log (src.data(me.target.source.data || {}).sql(me.eng.flavour));
    // console.log ("---------------");

    // const tpl = src.data(me.target.source.data || {})
    //     .sql(me.eng.flavour)
    // ;
    ...
    const tpl = Object.assign ({}
        , src.getSource(me.eng.flavour)
    );
    ///console.log(me.eng.flavour, tpl);
