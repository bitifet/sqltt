...
module.exports = function builder(base) {
    ...
    function keys(prmSpec, sep, wrapStr) {//{{{
        return base.entries.call(this, prmSpec, sep, wrapStr, '%1');
    }//}}}
    function values(prmSpec, sep, wrapStr) {//{{{
        return base.entries.call(this, prmSpec, sep, wrapStr, '$2');
    }//}}}
